...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath() %>/resource/css/index.css" media="all" />
	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="<%=request.getContextPath() %>/resource/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
						<dl class="layui-nav-child">
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="<%=request.getContextPath() %>/resource/images/face.jpg" class="userAvatar"></a>
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<%=request.getContextPath() %>/jsp.htm?page=main.jsp"></iframe>
					</div>
				</div>
			</div>
		</div>
